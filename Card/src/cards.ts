...
function createCard(card: Card): void {
    ...
    const cardDiv = document.querySelector(".card") as HTMLDivElement;
    cardDiv.innerHTML = cardTemplateHtml();
    // Left column on card: contains rank and suit at the top
    const colLeftRank = document.querySelector(".col-left-rank") as HTMLDivElement;
    const colLeftSuit = document.querySelector(".col-left-suit") as HTMLDivElement;
    // Right column on card: contains rank and suit at the bottom, upside down.
    const colRightRank = document.querySelector(".col-right-rank") as HTMLDivElement;
    const colRightSuit = document.querySelector(".col-right-suit") as HTMLDivElement;
    // Middle column on card: contains *rank* number of *suit* or image (J / Q / K)
    const colMiddle = document.querySelector(".col-middle") as HTMLDivElement;
...
function cardTemplateHtml(): string {
    return `
        <div class="col-left">
...
function cardDetailHtml(rank: string, suit: string): string {
...
function checkSuit(rank: string, rankCondition: string[], suit: string): string {
